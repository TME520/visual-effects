...
' Fonts
Global fontTEQUILAH10:TImageFont=LoadImageFont("incbin::./fonts/TEQUILAH.TTF",10)
Global fontTEQUILAH20:TImageFont=LoadImageFont("incbin::./fonts/TEQUILAH.TTF",20)
Global fontTEQUILAH30:TImageFont=LoadImageFont("incbin::./fonts/TEQUILAH.TTF",30)
Global fontTEQUILAH40:TImageFont=LoadImageFont("incbin::./fonts/TEQUILAH.TTF",40)
Global fontTEQUILAH50:TImageFont=LoadImageFont("incbin::./fonts/TEQUILAH.TTF",50)
Global fontTEQUILAH60:TImageFont=LoadImageFont("incbin::./fonts/TEQUILAH.TTF",60)
Global fontTEQUILAH70:TImageFont=LoadImageFont("incbin::./fonts/TEQUILAH.TTF",70)
Global fontTEQUILAH80:TImageFont=LoadImageFont("incbin::./fonts/TEQUILAH.TTF",80)
Global fontTEQUILAH90:TImageFont=LoadImageFont("incbin::./fonts/TEQUILAH.TTF",90)
Global fontTEQUILAH100:TImageFont=LoadImageFont("incbin::./fonts/TEQUILAH.TTF",100)
Global fontWELTRON40:TImageFont=LoadImageFont("incbin::./fonts/WELTRON2.TTF",40)
				...
				Else
					...
					Else
						If (iCompteurDefilementTexteNarratif>=601) And (iCompteurDefilementTexteNarratif<751) Then
							...
							afficherTexte("M","wel40",254,0,0,0,0,0,0,130,10)
							afficherTexte("A","wel40",241,124,54,0,0,0,0,170,10)
							afficherTexte("D","wel40",255,255,0,0,0,0,0,210,10)
