...
Function Start()
	...
	Global fontCHICK:TImageFont=LoadImageFont("incbin::./fonts/CHICK___.ttf",60)
	...
	Local bmCloudInLove:TImage=LoadImage("incbin::./pictures/cloud-in_love.png",FILTERED=-1)
	...
	' Stars
	Local bmNintenStar:TImage=LoadImage("incbin::./pictures/nintenstar-eyes_opened.png",FILTERED=-1)
	Local bmNintenStar2:TImage=LoadImage("incbin::./pictures/nintenstar-eyes_closed.png",FILTERED=-1)
	...
	'Hearts
	Local bmNintenHeart:TImage=LoadImage("incbin::./pictures/heart-eyes_opened.png",FILTERED=-1)
	Local bmNintenHeart2:TImage=LoadImage("incbin::./pictures/heart-eyes_closed.png",FILTERED=-1)
